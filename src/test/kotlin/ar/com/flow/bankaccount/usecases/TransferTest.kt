...
class TransferTest {
    ...
    internal fun transferBetweenDifferentAccountsSameCurrency() {
        ...
        transfer.transfer(debitCustomerName = "Juan Perez", currency = "ARS", amountToTransfer = 100, creditCustomerName = "David Gomez");

        val debitAccount = bankAccounts.accountOwnedBy(juanPerez, "ARS")
        assertThat(debitAccount.balance).isEqualTo(Balance("ARS", 0));

        val creditAccount = bankAccounts.accountOwnedBy(davidGomez, "ARS")
